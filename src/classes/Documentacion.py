class Usuario:
    ...
    def __init__(self):
        ...
        self.__nombreContactoPaisOrigen = input(
            "Ingrese el nombre de contacto en el país de origen: "
        )
        self.__nombreContactoPaisDestino = input(
            "Ingrese el nombre de contacto en el país de destino: "
        )
        self.__telefonoContactoPaisOrigen = input(
            "Ingrese el teléfono de contacto en el país de origen: "
        )
        self.__telefonoContactoPaisDestino = input(
            "Ingrese el teléfono de contacto en el país de destino: "
        )
        self.__reservaLugarDestino = input("Ingrese la reserva del lugar de destino: ")
        self.__direccionLugarDestino = input(
            "Ingrese la dirección del lugar de destino: "
        )
